package com.rajat.echo.databases
...
import com.rajat.echo.databases.EchoDatabase.Staticated.COLUMN_ID
import com.rajat.echo.databases.EchoDatabase.Staticated.COLUMN_SONG_ARTIST
import com.rajat.echo.databases.EchoDatabase.Staticated.COLUMN_SONG_PATH
import com.rajat.echo.databases.EchoDatabase.Staticated.COLUMN_SONG_TITLE
import com.rajat.echo.databases.EchoDatabase.Staticated.DB_VERSION
import com.rajat.echo.databases.EchoDatabase.Staticated.TABLE_NAME
...
class EchoDatabase: SQLiteOpenHelper{
    ...
    override fun onCreate(sqlLiteDatabase: SQLiteDatabase?) {
        sqlLiteDatabase?.execSQL("CREATE TABLE " + Staticated.TABLE_NAME + "( " + Staticated.COLUMN_ID + " INTEGER," + Staticated.COLUMN_SONG_ARTIST + " STRING,"
